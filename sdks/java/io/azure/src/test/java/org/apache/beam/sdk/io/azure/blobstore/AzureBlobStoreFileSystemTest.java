...
public class AzureBlobStoreFileSystemTest {
  ...
  public void testCopy() throws IOException {
    ...
    srcContainerClient.getBlobClient("src-blob").downloadToFile("./testingFiles/blob1");
    destContainerClient.getBlobClient("dest-blob").downloadToFile("./testingFiles/blob2");
    File file1 = new File("./testingFiles/blob1");
    File file2 = new File("./testingFiles/blob2");
